...
import com.example.moviesapp.databinding.ItemUpcomingMoviesBinding
...
class UpcomingMoviesAdapter : RecyclerView.Adapter<UpcomingMoviesAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(val binding: ItemUpcomingMoviesBinding) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.apply {
            tvUpcomingMovieTitle.text = movieItem.title
